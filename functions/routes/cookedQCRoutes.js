...
router.post('/perform', authMiddleware, roleMiddleware([2]), cookedQCController.performProductQC);
...
router.post('/risk-pool/transfer', authMiddleware, roleMiddleware([2]), cookedQCController.transferFromRiskPool);
